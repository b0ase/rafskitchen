...
const STABILITY_API_KEY = process.env.STABILITY_API_KEY; // Make sure this is set in your environment
const STABILITY_API_URL = 'https://api.stability.ai/v1/generation/stable-diffusion-xl-beta-v2-2-2/text-to-image';
...
async function generateImage(prompt, outputPath) {
  if (!STABILITY_API_KEY) {
    console.error('STABILITY_API_KEY is not set. Please set it in your environment variables.');
    return false;
  }
