...
export const portfolioData: PortfolioData = {
  about: {
    name: 'Raf\'s Kitchen',
    tagline: 'Culinary experiences and recipes for food enthusiasts.',
    bio: "Welcome to Raf's Kitchen - your destination for authentic recipes, cooking tips, and culinary adventures. Discover traditional flavors with a modern twist.",
    socials: {
    ...
    token: {
      name: 'RAF TOKEN',
      ticker: 'RAF',
      description: "RAF Token - Digital currency for the Raf's Kitchen community.",
      platform: 'BSV21',
      marketLink: '#'
    }
  },
