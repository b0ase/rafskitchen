...
export const portfolioData: PortfolioData = {
  about: {
    ...
    token: {
      name: "RAFS",
      ticker: "RAFS",
      description: "The native token of the RafsKitchen ecosystem, enabling governance, access to premium features, and participation in the tech incubation platform.",
