...
import { FaUserCircle, FaImage, FaSignature, FaInfoCircle, FaLink, FaSpinner, FaGlobe, FaGithub, FaLinkedin, FaTwitter, FaTiktok, FaTelegramPlane, FaFacebook } from 'react-icons/fa';
