          ...
          {userTeams.map(team => {
            ...
            return (
              <Link 
                ...
                className={`group p-3 flex flex-col justify-between border rounded-md shadow-none transition-all duration-200 ease-in-out hover:border-gray-600 ${cardBgColor} ${cardBorderColor} text-gray-400 cursor-pointer`}
              >
