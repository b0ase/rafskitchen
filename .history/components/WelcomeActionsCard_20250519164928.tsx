...
const WelcomeActionsCard: React.FC = () => {
      ...
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
        ...
        <div className="flex-grow text-center md:text-left">
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-4">
            <Link href="/projects/new" className={buttonStyle}>
              <FaRocket className="text-sky-300" /> Start a New Project
            </Link>
            <Link href="/teams/new" className={buttonStyle}>
              <FaUsers className="text-sky-300" /> Start a New Team
            </Link>
            <Link href="/projects/join" className={buttonStyle}>
              <FaLink className="text-sky-300" /> Join a Project
            </Link>
            <Link href="https://www.b0ase.com/teams/join" target="_blank" rel="noopener noreferrer" className={buttonStyle}>
              <FaHandshake className="text-sky-300" /> Join a Team
            </Link>
            <Link href="/careers" className={buttonStyle}>
