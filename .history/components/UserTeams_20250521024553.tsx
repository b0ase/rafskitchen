          ...
          {userTeams.map(team => {
            ...
            return (
              <Link 
                ...
                className="group p-3 bg-black border border-gray-800 rounded-md hover:border-gray-700 transition-all duration-200 shadow-sm hover:shadow-md"
              >
                <div className="flex items-center">
                  <IconComponent className="mr-2 text-sky-500 text-sm" />
                  <h3 className="font-medium text-white text-sm truncate">{team.name}</h3>
                </div>
              </Link>
            );
          })}
