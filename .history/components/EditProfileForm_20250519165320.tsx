      ...
      <form id="profile-form" onSubmit={onSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            required
            className="mt-1 block w-full rounded-md bg-gray-900 border-gray-700 shadow-sm text-gray-300 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 sm:text-sm p-3"
