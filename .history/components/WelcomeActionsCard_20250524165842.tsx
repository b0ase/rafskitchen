      ...
      <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
        ...
        <div className="flex-grow text-center md:text-left">
          ...
          <p className="text-lg text-sky-100/90 mb-6 leading-relaxed">
            Welcome to RafsKitchen! This is your hub to bring your digital ideas to life. Start a new project to define your vision, outline features, and begin collaborating with our team. Whether it's a website, a mobile app, an AI solution, or something entirely new, we're here to help you build it.
          </p>
          <div className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-4">
            ...
            <Link href="https://rafskitchen.website/teams/join" target="_blank" rel="noopener noreferrer" className={buttonStyle} onClick={handleLinkClick}>
