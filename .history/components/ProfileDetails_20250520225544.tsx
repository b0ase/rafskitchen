    ...
    <section className="relative mb-12 p-6 md:p-8 bg-gray-900 rounded-xl shadow-2xl text-white border border-gray-700">
      ...
      {onSaveProfile && (
        <button
          ...
          disabled={saving}
          className="sticky bottom-6 right-6 z-20 px-4 py-2 rounded-md text-sm font-medium flex items-center bg-sky-600 hover:bg-sky-700 text-white focus:outline-none focus:ring-2 focus:ring-sky-500 disabled:opacity-50 shadow-lg"
