...
const getSkillBadgeStyle = (category: string | null): string => {
  // Vercel-like monochrome style for all badges
  const baseStyle = "px-3 py-1.5 text-xs font-semibold rounded-full shadow-sm flex items-center justify-center";
  return `${baseStyle} bg-gray-800 text-gray-300 border border-gray-700 hover:bg-gray-700`;
};
               ...
               <button
                onClick={() => {
                  if (skillChoiceInAdder) {
                    onSkillToggle(skillChoiceInAdder, false);
                  }
                }}
