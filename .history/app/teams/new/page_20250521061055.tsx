...
import { FiActivity, FiAirplay, FiAperture, FiBarChart2, FiBriefcase, FiCloudLightning, FiCpu, FiDisc, FiGitMerge, FiHardDrive, FiLayers, FiShield, FiTerminal, FiZap, FiDatabase as FiDb } from 'react-icons/fi';
...
// Updated predefined color schemes with subtle gradients - Expanded List
const predefinedColorSchemes: ColorScheme[] = [
  ...
  { name: 'Sky Tint', bgColor: 'bg-gradient-to-bl from-lightBlue-600 to-sky-700', textColor: 'text-lightBlue-200', borderColor: 'border-lightBlue-500' }, // Note: lightBlue might need Tailwind JIT config for `from-lightBlue-600` etc. Assuming it works or replace with `blue-xxx`.
  { name: 'Warm Gray', bgColor: 'bg-gradient-to-bl from-warmGray-700 to-warmGray-800', textColor: 'text-warmGray-300', borderColor: 'border-warmGray-600' }, // Note: warmGray might need Tailwind JIT. Assuming `neutral` or `stone` can be alternatives.
  { name: 'Blue Night', bgColor: 'bg-gradient-to-tl from-blue-gray-700 to-blue-gray-800', textColor: 'text-blue-gray-300', borderColor: 'border-blue-gray-600' }, // Note: blue-gray. Assuming `slate` or `coolGray`.
  ...
  // Additional Set 2 (12 more to reach 36)
        ...
        <div className="bg-black shadow-xl rounded-lg p-8 border border-gray-700">
          <form onSubmit={handleCreateTeam} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-6 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 gap-2 mt-2">
                ...
                {predefinedColorSchemes.map((scheme) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-2 rounded-md border-2 transition-all duration-150 ease-in-out text-center 
