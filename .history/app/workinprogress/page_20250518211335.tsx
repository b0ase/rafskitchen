    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-gray-300 flex flex-col">
      <main className="flex-grow container mx-auto px-4 py-12 md:py-16">
              ...
              allUserTasks.map(item => (
                <div key={item.id} className="p-4 bg-gray-800 border border-gray-700 rounded-md shadow-sm">
                  <div className="flex justify-between items-center gap-3">
                    <p className="text-gray-300 flex-grow break-all">{item.text}</p>
        ...
        {showScheduleModal && taskToSchedule && user && (
          ...
          >
            <div 
              className="bg-gray-900 rounded-lg max-w-xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl p-6 space-y-4"
              onClick={(e) => e.stopPropagation()} 
            >
              <h3 className="text-xl font-semibold text-white mb-2">Schedule Task to Calendar</h3>
              <p className="text-sm text-gray-400 mb-4">
                Scheduling task: <span className="font-medium text-gray-300">{taskToSchedule.text}</span>
              </p>
              <EventForm 
