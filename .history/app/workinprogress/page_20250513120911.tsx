...
export default function WorkInProgressPage() {
  ...
  const boaseActionItems = [
    { id: 'b1', text: 'Define authentication flow for Studio sections', status: 'todo' },
    { id: 'b2', text: 'Integrate Google Sheets API for Financial Overview', status: 'todo' },
    { id: 'b3', text: 'Design editable daily schedule modal for Work Path', status: 'inprogress' },
  ];

  const otherActionItems = [
    { id: 'o1', text: 'NinjaPunkGirls.com - Complete character design for Void', status: 'inprogress' },
    { id: 'o2', text: 'Miss Void Website - Finalize homepage copy', status: 'todo' },
