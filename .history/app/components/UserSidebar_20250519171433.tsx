...
import {
  ...
  FaCamera, FaComments, FaUserSecret, FaCubes
} from 'react-icons/fa';
...
const navLinksPrimaryConst: NavLink[] = [
  ...
  { title: 'My Agent', href: '/myagent', icon: FaUserSecret },
  { title: 'My Token', href: '/mytoken', icon: FaCubes },
...
interface UserSidebarProps {
  // onSetPageContext: (context: PageContextType | null) => void; // Removed, will use context directly
}

export default function UserSidebar({ /* props removed */ }: UserSidebarProps) {
  ...
  return (
    <aside className="w-64 min-h-screen bg-black text-gray-300 flex flex-col fixed top-0 left-0 z-40 pt-5 shadow-lg">
      {/* User Info Section */}
      ...
      <div className="px-4 py-3 mt-auto border-t border-gray-700">
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-2.5 text-sm font-medium rounded-md text-gray-300 bg-gray-800 hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black focus:ring-gray-500 transition-colors duration-150 ease-in-out"
        >
