...
export default function ServicesNavigation() {
  ...
  return (
    ...
    <nav 
      className="hidden md:flex sticky z-30 w-full bg-gray-100 dark:bg-gray-900 border-b border-gray-300 dark:border-gray-700 shadow-sm px-4"
      style={{ top: headerHeight }} // Apply sticky top dynamically
    >
      <div className="container mx-auto flex justify-center items-center h-10 space-x-5">
