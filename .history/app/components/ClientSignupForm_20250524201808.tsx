    ...
    <div className="space-y-8">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <label htmlFor="requested_budget" className="block text-sm font-medium text-gray-300">What is your ideal budget for this project? (Optional)</label>
            <input
              id="requested_budget"
              type="number"
              className="mt-1 w-full px-3 py-2 bg-gray-800 border border-gray-700 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500"
