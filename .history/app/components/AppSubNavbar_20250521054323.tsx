          ...
          */}
          ...
          <div className={`flex-grow ${linkContainerClasses}`}>
            {displayedLinks.map((link, index) => {
              ...
              // Updated button styling to match landing page aesthetics - Reduced horizontal padding
              const buttonBaseClasses = `px-2.5 py-2.5 rounded-md text-sm font-medium transition-colors duration-150 ease-in-out border`; // Changed px-3 to px-2.5
