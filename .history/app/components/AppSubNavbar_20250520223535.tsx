...
export default function AppSubNavbar({ initialIsExpanded, onCollapse }: AppSubNavbarProps) {
  ...
  return (
    <div className={`bg-gradient-to-r from-black via-gray-900 to-gray-800 text-gray-300 shadow-lg sticky top-16 z-30 transition-all duration-300 ease-in-out border-t border-gray-700`}>
