      ...
      <div className="container mx-auto px-2 sm:px-4">
        ...
        <div className={`flex items-center justify-between py-2.5 sm:py-3 ${!isExpanded && !isDesktop ? 'hidden' : ''}`}> 
          ...
          <div className={`flex-grow ${linkContainerClasses}`}>
            ...
            {/* Render Admin button if user is admin and not in collapsed mobile view and not on the team management page */}
            {!isExpanded && isDesktop && user?.email === 'richardwboase@gmail.com' && pathname !== '/teammanagement' && (
