...
import { usePageHeader, PageContextType } from './MyCtx'; // Ensure this is relative
...
export default function UserSidebar({ /* onSetPageContext, */ isSidebarOpen, toggleSidebar }: UserSidebarProps) {
  ...
  const handleLinkClick = useCallback((link: NavLink) => {
    ...
    if (isSidebarOpen && toggleSidebar) {
        toggleSidebar(); // Close sidebar on mobile after link click
    }
  }, [setPageContext, isSidebarOpen, toggleSidebar]);
