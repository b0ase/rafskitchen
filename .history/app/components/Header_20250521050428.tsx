...
import { FaGithub, FaLinkedin, FaEnvelope, FaWhatsapp, FaTwitter, FaBars, FaTimes, FaLock, FaTelegramPlane, FaDiscord } from 'react-icons/fa';
...
export default function Header() {
  ...
  const socialLinks = [
    ...
    { Icon: FaTwitter, href: portfolioData.about.socials.x },
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-3">
            {/* Filter out links that might not have a valid href if needed */}
            {socialLinks
              .filter(link => link.href && !link.href.includes('#')) // Basic filter for placeholder links
              .map((link, index) => (
