...
export default function UserSidebar({ /* props removed */ }: UserSidebarProps) {
  ...
  return (
    <aside className={`fixed top-0 left-0 z-30 w-64 h-screen bg-gray-900 text-gray-300 flex-col transition-transform duration-300 ease-in-out transform -translate-x-full md:translate-x-0 hidden md:flex`}>
