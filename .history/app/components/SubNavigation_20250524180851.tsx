...
export default function SubNavigation() {
  return (
    // Modern gradient design with floating effect
    <nav className="hidden md:flex sticky top-[80px] z-30 w-full bg-gradient-to-r from-indigo-900/90 via-purple-900/90 to-pink-900/90 backdrop-blur-md border-b border-purple-400/20 shadow-xl px-6 py-3">
