        ...
        <div className={`flex items-center justify-between py-3 ${isExpanded ? '' : 'border-t border-gray-800'}`}>
          ...
          {isProfilePage && onSaveProfile && (
            <button
              ...
              className="mr-2 px-3 py-2 rounded-md text-sm font-medium flex items-center bg-sky-600 hover:bg-sky-700 text-white focus:outline-none focus:ring-2 focus:ring-sky-500 flex-shrink-0"
