  ...
  return (
    <div className={`bg-gray-900 text-gray-300 shadow-md sticky top-28 z-30 transition-all duration-300 ease-in-out`}>
      <div className="container mx-auto px-4">
        ...
        <div className={`flex items-center ${isExpanded ? 'justify-center' : 'justify-between'} py-3 border-t border-gray-800`}>
          <div className={`flex items-center space-x-2 sm:space-x-3 md:space-x-4 overflow-x-auto whitespace-nowrap ${isExpanded ? '' : 'flex-grow'}`}>
            {navLinks.map((link) => {
          ...
          <button 
            ...
            className="ml-4 p-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-600"
