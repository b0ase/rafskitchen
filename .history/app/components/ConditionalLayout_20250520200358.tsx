...
// import FullScreenMobileMenu from './FullScreenMobileMenu'; // REMOVE Import new menu
...
export default function ConditionalLayout({ children }: ConditionalLayoutProps) {
  ...
  // const [isFullScreenMenuOpen, setIsFullScreenMenuOpen] = React.useState(false); // REMOVE
  ...
  // const toggleFullScreenMenu = () => { // REMOVE
      ...
      <MyCtxProvider>
        <div className="flex h-screen bg-black">
          ...
          <div className={`flex-1 flex flex-col overflow-hidden md:ml-64`}>
            <AppNavbar 
              // toggleFullScreenMenu={toggleFullScreenMenu} // REMOVE PROP
              // isFullScreenMenuOpen={isFullScreenMenuOpen} // REMOVE PROP
            />
            <AppSubNavbar 
