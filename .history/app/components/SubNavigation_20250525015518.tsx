...
const sections = [
  ...
  { name: 'DeFi Exchange Dev', href: '/services/defi-exchange' },
  { name: 'Platform Dev', href: '/services/blockchain-platform' },
  { name: 'Tokenization & Assets', href: '/services/tokenization-services' },
  { name: 'Capital & Team Building', href: '/services/capital-raising' },
  { name: 'Business Dev & Strategy', href: '/services/business-development' },
      ...
      <div className="w-full flex justify-between items-center space-x-8">
        ...
        <div className="flex items-center space-x-3">
          <div className="hidden lg:flex items-center space-x-3">
            {/* Fiverr, Upwork, Freelancer links removed */}
          </div>
