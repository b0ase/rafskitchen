        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="md:hidden">
            <button 
              ...
              className="p-3 rounded-lg text-gray-700 hover:text-black bg-gray-100 hover:bg-gray-200 focus:outline-none transition-all duration-300 border border-gray-300 min-w-[44px] min-h-[44px] flex items-center justify-center"
            >
