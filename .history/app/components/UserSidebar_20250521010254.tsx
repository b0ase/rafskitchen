...
export default function UserSidebar({ className }: UserSidebarProps) { // Destructure className
  ...
  return (
    <aside 
      className={`fixed inset-y-0 left-0 z-50 flex-col w-64 bg-black text-white transform transition-transform duration-300 ease-in-out ${className} md:translate-x-0`}
      aria-label="Sidebar"
    >
      {/* User Info Section */}
