      ...
      <main className="container mx-auto px-4 py-12 md:py-16 flex-grow">
        ...
        <section id="about" className="mb-16 md:mb-24 scroll-mt-20">
          <div className="bg-white dark:bg-black p-6 md:p-8 border border-gray-200 dark:border-gray-800 shadow-md dark:shadow-xl">
            ...
            <p className="text-base text-gray-600 dark:text-gray-400 mb-6 whitespace-pre-line">{portfolioData.about.bio}</p>
        ...
        <section id="services" className="mb-16 md:mb-24 scroll-mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {portfolioData.services.map((service) => (
              <div key={service.id} className="bg-white dark:bg-black p-6 border border-gray-200 dark:border-gray-800 shadow-md dark:shadow-xl flex flex-col transition-transform duration-300 ease-in-out hover:scale-[1.02] hover:brightness-110 dark:hover:brightness-125">
                  ...
                  {project.status && (
                    <span className={`text-xs font-medium mr-2 px-2 py-0.5 mb-2 inline-block w-max border 
                      ${project.status === 'Live' ? 'bg-green-100 border-green-300 text-green-800 dark:bg-green-900 dark:border-green-700 dark:text-green-300' : 
                       ...
                       'bg-gray-100 border-gray-300 text-gray-800 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400'}
                    `}>
                       {project.status}
                    </span>
                  )}
