  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="px-6 py-12 md:py-16 flex-grow">
        ...
        {/* Updated Hero Section - Now more compact */}
        <section id="hero" className="py-16 md:py-20 text-center bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 text-white"> {/* Reduced padding */}
          <div className="max-w-6xl mx-auto px-4"> 
            <div className="mx-auto"> 
              <h1 className="font-bold text-white mb-6 md:mb-8"> 
                <span className="block text-7xl md:text-9xl font-extrabold tracking-tight mb-2 md:mb-3">
                  RAFSKITCHEN
                </span>
              ...
              <p className="text-lg md:text-xl text-gray-300 mb-0"> {/* Removed bottom margin as section is shorter */}
            ...
            {/* Feature cards and their heading have been removed from here */}
          </div>
        </section>

        {/* New Section for Key Platform Capabilities Cards */}
        <section id="platform-features" className="py-16 md:py-20 bg-gray-50">
          <div className="max-w-6xl mx-auto px-4">
            {/* <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 mb-10 md:mb-12 text-center">Key Platform Capabilities</h2> */}
            {/* The heading is commented out as per the request to remove it */}
