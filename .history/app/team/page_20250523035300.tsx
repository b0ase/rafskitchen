...
const getRoleStyle = (role: string): string => {
  ...
  } else if (roleLower === ProjectRole.Freelancer || roleLower === 'freelancer' || roleLower === 'collaborator') {
    style += "bg-green-700/70 text-green-200";
  } else if (roleLower === ProjectRole.CLIENT || roleLower === 'client' || roleLower === 'clientcontact') {
    style += "bg-purple-700/70 text-purple-200";
  } else if (roleLower === ProjectRole.Viewer || roleLower === 'viewer') {
