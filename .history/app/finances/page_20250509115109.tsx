...
import { FaUniversity, FaBitcoin, FaExchangeAlt, FaPlusCircle, FaTable, FaChartPie, FaSignOutAlt, FaEye, FaEyeSlash } from 'react-icons/fa';
        ...
        <section className="mb-12">
          ...
          <div className="mb-8 p-6 bg-gray-900 border border-gray-800 shadow-lg">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 text-sm font-medium flex items-center"><FaPlusCircle className="mr-2" /> Connect New Account</button>
            </div>
