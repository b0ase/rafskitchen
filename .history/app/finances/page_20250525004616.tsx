...
import { FaUniversity, FaBitcoin, FaExchangeAlt, FaPlusCircle, FaTable, FaChartPie, FaSpinner, FaGoogle, FaDollarSign, FaChartLine, FaCreditCard, FaWallet, FaFileInvoiceDollar, FaPiggyBank, FaExternalLinkAlt } from 'react-icons/fa';
