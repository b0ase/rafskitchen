  ...
  return (
    ...
    >
      <Link href={`/myprojects/${project.project_slug}`} passHref legacyBehavior>
        <a className="block w-full h-full p-6 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500/50" 
           // No complex onClick here, Link handles navigation
        >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-3">
            <div className="flex items-center gap-x-3">
              ...
              <Link href={`/myprojects/${project.project_slug}/edit`} passHref legacyBehavior>
                <a 
                  className="text-gray-400 hover:text-sky-400 transition-colors relative z-10" // Added z-10
                  title="Edit Project"
            ...
            {currentUser && project.user_id === currentUser.id && (
              <Link href={`/myprojects/${project.project_slug}/manage-members`} passHref legacyBehavior>
                <a 
                  className="mt-2 sm:mt-0 ml-0 sm:ml-auto inline-flex items-center bg-blue-600 hover:bg-blue-500 text-white font-semibold py-1.5 px-3 rounded-md text-xs transition-colors shadow hover:shadow-md relative z-10" // Added z-10
                  onClick={(e) => e.stopPropagation()}
                >
          ...
          <div className="mt-2 mb-4 space-y-3 sm:space-y-0 sm:flex sm:flex-wrap sm:items-center sm:gap-3">
            <div className="flex-shrink-0">
              ...
              <select 
                ...
                className={`${getBadgeStyle(project.badge1 || 'Pending_setup')} relative z-10`} // Added z-10
                onClick={(e) => e.stopPropagation()} 
              >
            ...
            <div className="flex-shrink-0">
              ...
              <select 
                ...
                disabled={updatingItemId === project.id}
                className={`${getBadge2Style(project.badge2 || '')} relative z-10`} // Added z-10
                onClick={(e) => e.stopPropagation()} 
              >
            ...
            <div className="flex-shrink-0">
              ...
              <select 
                ...
                disabled={updatingItemId === project.id}
                className={`${getBadge3Style(project.badge3 || '')} relative z-10`} // Added z-10
                onClick={(e) => e.stopPropagation()} 
              >
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center mt-auto pt-3 border-t border-slate-700/50">
            <div className="flex items-center gap-x-2">
              <input 
                ...
                disabled={updatingItemId === project.id}
                className="form-checkbox h-4 w-4 text-sky-600 bg-gray-800 border-gray-600 rounded focus:ring-sky-500 transition duration-150 ease-in-out relative z-10" // Added z-10
                onClick={(e) => e.stopPropagation()} 
              />
            ...
            {currentUser && project.user_id === currentUser.id && (
              <button 
                ...
                disabled={updatingItemId === project.id}
                className="mt-3 sm:mt-0 inline-flex items-center bg-red-700 hover:bg-red-600 text-white font-semibold py-1.5 px-3 rounded-md text-xs transition-colors shadow hover:shadow-md disabled:opacity-50 relative z-10" // Added z-10
              >
