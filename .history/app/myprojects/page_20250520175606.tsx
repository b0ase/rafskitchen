...
const getCardDynamicBorderStyle = (priorityValue: number): string => {
  let baseStyle = "p-6 shadow-lg rounded-lg hover:border-gray-400 transition-colors duration-300 relative border-2 bg-black"; // Changed bg-slate-900 to bg-black, hover:border-slate-500 to hover:border-gray-400

  // All borders will be white, or a slightly off-white for hover, to achieve the "white edges" look.
  // If priority colors are still desired, this switch can be reactivated with different color values.
  return `${baseStyle} border-white`; 
