...
export default function ProjectPreviewPage({ params }: { params: { slug: string } }) {
  ...
  const clientName = projectSlug.replace(/-com$/, '').replace(/-/g, '-'); // Format slug as client name
  const websiteName = projectSlug; // Use slug as website name (e.g., "robust-ae.com")
      ...
      <nav className="bg-gray-800 p-4 shadow-md sticky top-0 z-50">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="space-x-4">
             ...
             {/* Link back to Project Hub (only show in standalone preview and after mounted) */}
             {mounted && (
