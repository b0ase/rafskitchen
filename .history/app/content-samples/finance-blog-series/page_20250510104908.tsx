      ...
      <section className="px-4 md:px-8 mb-12">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-300 mb-4">
            This series covered topics from budgeting basics to investment strategies, making complex financial concepts accessible to a broad audience. The goal was to establish the client as a thought leader and improve SEO performance.
          </p>
        </div>
      </section>
      <section className="px-4 md:px-8 mb-12">
