      ...
      <section className="px-4 md:px-8 mb-12">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-gray-300 mb-4">
            This project involved rewriting hundreds of product descriptions for a luxury e-commerce retailer. The goal was to increase conversion rates, improve SEO, and create a consistent, engaging brand voice across the catalog.
          </p>
        </div>
      </section>
      <section className="px-4 md:px-8 mb-12">
