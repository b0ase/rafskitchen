...
const portfolioData = {
  about: {
    name: 'b0ase',
    bio: "b0ase.com operates as a dynamic digital agency, dedicated to transforming concepts into tangible digital experiences. We partner with clients to deliver tailored solutions in web development, blockchain integration, compelling content creation, video production, and strategic social media management. Alongside our client work, we actively incubate and develop our own portfolio of innovative projects. Explore our diverse service offerings, view our development pipeline, and connect with us to discuss how b0ase can empower your digital presence or next big idea.",
    links: {
