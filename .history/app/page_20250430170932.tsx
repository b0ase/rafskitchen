    ...
    <div className="min-h-screen bg-gray-900 text-gray-200 font-sans">
      ...
      <main className="container mx-auto px-4 py-16">
            ...
            {portfolioData.projects.map((project) => (
              ...
              (<div key={project.id} className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="text-blue-400 hover:text-blue-300 underline mt-auto"
                >
                  View Project →
                </a>
              </div>)
        ...
        <section id="skills" className="mb-16 scroll-mt-16">
          <h2 className="text-3xl font-semibold mb-8 border-b border-gray-700 pb-2 text-white">Technical Skills</h2>
          <div className="flex flex-wrap gap-2">
            {portfolioData.skills.map((skill) => (
              <span 
                key={skill} 
                className="bg-gray-700 text-blue-300 text-sm font-medium px-3 py-1 rounded-full shadow-md"
              >
                {skill}
              </span>
            ))}
        ...
        <section id="services" className="mb-16 scroll-mt-16">
          {/* Section Title */}
          <h2 className="text-3xl font-semibold mb-8 border-b border-gray-700 pb-2 text-white">Services</h2>
