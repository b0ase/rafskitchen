      ...
      <div className="min-h-screen bg-black text-gray-300 font-sans flex flex-col">
        ...
        <main className="flex-grow container mx-auto px-4 py-16 flex items-center justify-center">
          <div className="w-full max-w-xs">
            <form onSubmit={handlePasswordSubmit} className="bg-gray-900 shadow-md px-8 pt-6 pb-8 mb-4">
              ...
              <div className="mb-4">
                ...
                <input
                  className="shadow appearance-none border w-full py-2 px-3 bg-gray-800 text-gray-200 border-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-gray-500"
                  id="password"
                  type="password"
                  placeholder="******************"
                  value={password}
              ...
              <div className="flex items-center justify-between">
                <button
                  className="bg-gray-700 hover:bg-gray-600 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline"
                  type="submit"
                >
                  Enter Studio
                </button>
    ...
    <div className="min-h-screen bg-black text-gray-300 font-sans flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-16">
        ...
        <div className="bg-gray-900 p-6 shadow-lg">
          ...
          <textarea 
            className="w-full p-3 bg-gray-800 text-gray-200 border border-gray-700 focus:outline-none focus:border-gray-500 focus:ring-1 focus:ring-gray-600"
            rows={10}
