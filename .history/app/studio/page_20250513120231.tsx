        ...
        <div className="bg-gray-900 p-6 md:p-8 border border-gray-800 shadow-lg">
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {[
                // Rainbow color sequence assigned
                { href: '/workinprogress', title: 'Work In Progress', description: 'Overview of current tasks, projects, and ongoing efforts.', color: 'red' },
                { href: '/diary', title: 'Diary', description: 'Personal journal, daily notes, and reflections.', color: 'orange' },
                { href: '/gigs/calendar', title: 'Calendar', description: 'Visualize deadlines, learning sessions, and financial check-ins.', color: 'yellow' },
                { href: '/finances', title: 'Financial Overview', description: 'View income, expenses, and financial reports.', color: 'green' },
                { href: '/gigs', title: 'Gig Management', description: 'Track freelance projects, proposals, and client interactions.', color: 'blue' },
                { href: '/gigs/research', title: 'Research', description: 'Explore Fiverr trends, popular gigs, pricing, and keywords.', color: 'indigo' },
                { href: '/gigs/strategy', title: 'Strategy', description: 'Define specific gig offerings, unique selling points, and target audiences.', color: 'purple' },
                { href: '/gigs/action', title: 'Action Plan', description: 'Detailed steps to create and launch gigs for each platform/service.', color: 'red' }, // Repeat Red
                { href: '/gigs/learning-path', title: 'Learning Path', description: 'Follow a structured 3-month schedule to master each platform.', color: 'orange' }, // Repeat Orange
                ...
                { href: '/gigs/work-path', title: 'Work Path', description: 'Manage your daily workflow and balance client work with skill development.', color: 'green' }, // Repeat Green
                { href: '/gigs/fiverr-explorer', title: 'Fiverr Explorer', description: 'Browse Fiverr categories and scrape gig data for research.', color: 'blue' }, // Repeat Blue
              ].map((item, index) => (
