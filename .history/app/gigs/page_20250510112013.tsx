  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link href="/fiverrscraper" className="block p-6 bg-gray-800 border border-gray-700 rounded-lg hover:bg-gray-700 transition-colors border-indigo-500/30">
          <h2 className="text-xl font-semibold mb-2 text-indigo-400">Fiverr Explorer</h2>
          <p className="text-gray-400">Browse Fiverr categories and scrape gig data for research.</p>
        </Link>
      </div>
    </div>
  );
