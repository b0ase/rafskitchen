  ...
  const scheduleOptions = [
    {
      ...
      schedule: [
        ...
        { time: '8:30-9:00', activity: 'Admin & Planning (Check messages, schedule, plan day)', priority: 'high' },
        ...
        { time: '19:30-21:00', activity: 'Structured Evening Work (Client or learning, with clear endpoint)', priority: 'medium' },
    ...
    },
    {
      ...
      schedule: [
        { time: '7:00-8:30', activity: 'Morning Routine (Dog walk, exercise, shower, breakfast)', priority: 'high' },
        { time: '8:30-9:00', activity: 'Admin & Planning (Check messages, schedule, plan day)', priority: 'medium' },
        { time: '9:00-10:00', activity: 'Client Work Block (Any urgent tasks only)', priority: 'medium' },
        ...
        { time: '17:30-18:30', activity: 'Evening Dog Walk & Personal Time', priority: 'medium' },
        { time: '18:30-19:30', activity: 'Dinner & Financial Review (15 min spending check)', priority: 'high' },
        { time: '19:30-21:00', activity: 'Structured Evening Learning (Specific project, with clear endpoint)', priority: 'medium' },
        { time: '21:00-22:30', activity: 'Deliberate Wind-Down (Non-screen hobby, reading, planned social)', priority: 'high' }
      ]
    },
    {
      id: 'night-owl',
      title: 'Night Owl Schedule',
      description: 'For when you need to work late but want to maintain healthy boundaries.',
      schedule: [
        { time: '7:00-8:30', activity: 'Morning Routine (Dog walk, exercise, shower, breakfast)', priority: 'high' },
        { time: '8:30-11:00', activity: 'Client Work or Learning (Medium priority tasks)', priority: 'medium' },
        { time: '11:00-12:00', activity: 'Admin Tasks & Planning', priority: 'medium' },
        { time: '12:00-13:00', activity: 'Lunch Break', priority: 'medium' },
        { time: '13:00-15:00', activity: 'Low-Focus Activities (Emails, minor updates, reviews)', priority: 'low' },
        ...
        { time: '18:00-19:00', activity: 'Buffer Time (Non-work activity before focused evening)', priority: 'high' },
        { time: '19:00-21:30', activity: 'Primary Evening Work Block I (High-focus, creative work)', priority: 'high' },
        { time: '21:30-22:00', activity: 'Deliberate Break (Move, hydrate, no screens)', priority: 'high' },
        { time: '22:00-23:30', activity: 'Primary Evening Work Block II (Set clear endpoint)', priority: 'high' },
