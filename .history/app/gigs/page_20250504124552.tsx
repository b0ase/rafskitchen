...
export default function GigsPage() {
  const [activeTab, setActiveTab] = useState<'research' | 'strategy' | 'action' | 'platforms'>('research');
            ...
            <div className="space-y-8">
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-850">
                ...
                <ul className="list-decimal list-inside space-y-1 text-sm text-gray-300">
                  ...
                  <li>**Write Titles & Descriptions:** Optimize with Shopify-related keywords. Clearly define scope & deliverables.</li>
                  <li>**Create Visuals:** Design professional images/video showcasing Shopify expertise & results.</li>
                  <li>**Set Pricing & Extras:** Research competitor pricing. Define relevant extras (e.g., more products, faster delivery, SEO setup).</li>
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-850">
                ...
                <ul className="list-decimal list-inside space-y-1 text-sm text-gray-300">
                  ...
                  <li>**Write Titles & Descriptions:** Use WP keywords (WordPress, WooCommerce, Elementor, etc.). Clearly define scope.</li>
                  <li>**Create Visuals:** Design images/video showcasing WP skills (site examples, backend shots).</li>
                  <li>**Set Pricing & Extras:** Price competitively. Offer extras (more pages, SEO, security, maintenance).</li>
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-850">
                ...
                <ul className="list-decimal list-inside space-y-1 text-sm text-gray-300">
                  ...
                  <li>**Write Titles & Descriptions:** Use keywords (React, Next.js, Frontend, Component). Specify deliverables.</li>
                  <li>**Create Visuals:** Show code snippets (cleanly formatted), UI examples, architecture diagrams.</li>
                  <li>**Set Pricing & Extras:** Tier pricing by complexity. Offer extras (testing, state management setup, performance tuning).</li>
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-850">
                ...
                <ul className="list-decimal list-inside space-y-1 text-sm text-gray-300">
                  ...
                  <li>**Write Titles & Descriptions:** Use keywords (Node.js, Express, API, Backend, Microservice). Detail tech stack.</li>
                  <li>**Create Visuals:** Show API documentation examples (Swagger?), code structure, deployment flow.</li>
                  <li>**Set Pricing & Extras:** Price based on API complexity/scale. Extras: authentication, database setup, deployment assistance.</li>
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-850">
                ...
                <ul className="list-decimal list-inside space-y-1 text-sm text-gray-300">
                  ...
                  <li>**Write Titles & Descriptions:** Use keywords (Figma, UI, UX, Prototype, Design System). Emphasize process.</li>
                  <li>**Create Visuals:** High-quality mockups, prototype demos (GIFs/videos), design system examples.</li>
                  <li>**Set Pricing & Extras:** Tier by scope/deliverables. Extras: responsive versions, interactive prototyping, style guide.</li>
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-850">
                ...
                <ul className="list-decimal list-inside space-y-1 text-sm text-gray-300">
                  ...
                  <li>**Write Titles & Descriptions:** Use AWS service keywords (EC2, S3, Lambda, RDS). Specify problem solved.</li>
                  <li>**Create Visuals:** Architecture diagrams, screenshots of AWS console/configs, performance graphs.</li>
                  <li>**Set Pricing & Extras:** Price based on scope/complexity. Extras: monitoring setup, documentation, ongoing support.</li>
              ...
              <div className="p-4 border border-gray-700 rounded-lg bg-gray-850">
                ...
                <ul className="list-decimal list-inside space-y-1 text-sm text-gray-300">
                  ...
                  <li>**Write Titles & Descriptions:** Use keywords (OpenAI, GPT, Chatbot, AI Integration). Explain use case clearly.</li>
                  <li>**Create Visuals:** Demo videos of the AI tool in action, flowcharts, example outputs.</li>
                  <li>**Set Pricing & Extras:** Tier by features/complexity. Extras: fine-tuning help, usage monitoring setup, extended support.</li>
