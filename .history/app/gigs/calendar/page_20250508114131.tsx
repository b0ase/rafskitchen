      ...
      <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
        <div className="bg-gray-900 rounded-lg max-w-xl w-full max-h-[80vh] overflow-hidden flex flex-col shadow-2xl">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            {dayEvents.length === 0 ? (
              <p className="text-gray-400 text-center py-6">No events scheduled for this day.</p>
            ) : (
          ...
          <div className="p-4 border-t border-gray-700 bg-gray-850">
            <button
              onClick={closeDayModal}
              className="w-full py-2 bg-gray-700 hover:bg-gray-600 text-white rounded font-medium transition-colors"
            >
              Close
            </button>
          </div>
            ...
            <div className="flex flex-wrap gap-2">
              {!isGoogleCalendarConnected ? (
                <button 
                  ...
                  disabled={isSyncing}
                  className="px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md text-sm font-medium flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSyncing ? (
                    <>
