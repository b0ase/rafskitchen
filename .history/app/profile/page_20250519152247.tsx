...
export default function ProfilePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-white px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 overflow-x-hidden">
                      ...
                      {selectedSkills.length === 0 ? (
                        ...
                        selectedSkills.map(skill => (
                          <span 
                            ...
                            onClick={() => handleSkillToggle(skill.id, true)} // Pass true as it's currently selected
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex gap-2">
                        <select
                          ...
                          onChange={(e) => setSkillChoiceInAdder(e.target.value)}
                         ...
                         <button
                          onClick={() => {
                            if (skillChoiceInAdder) {
                              handleSkillToggle(skillChoiceInAdder, false); // Pass false as it's NOT currently selected by the user
                              setSkillChoiceInAdder(''); // Reset dropdown
                            }
                          }}
                    ...
                    <div className="mb-4">
                       ...
                       <div className="flex gap-2">
                        <input
                           ...
                           className="block w-full px-4 py-2 rounded-md bg-gray-700 border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:ring-sky-500 focus:border-sky-500 sm:text-sm"
                        />
                         <button
      ...
      <div className="sticky top-0 z-50 w-full flex justify-end p-4 bg-black bg-opacity-80 backdrop-blur-sm">
        <button
          type="submit"
          form="profile-form" {/* Associate button with the form below */}
          disabled={saving}
