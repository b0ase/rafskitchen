...
export default function ProfilePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-white p-4 md:p-6 lg:p-8">
      ...
      <div className="mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
          ...
          <section className="mt-10 pb-6 mb-10 border-b border-gray-700 md:w-1/2">
          ...
          <section className="my-10 pb-6 border-b border-gray-700 md:w-1/2">
