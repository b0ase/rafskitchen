      ...
      <main className="flex-grow px-4 sm:px-6 lg:px-8 bg-black">
        <div className="mx-auto bg-black">
          ...
          <div className="text-center sm:text-left ml-0 sm:ml-6 flex-grow">
            {/* Editable Display Name - This will be moved into the form row below */}
            {/* 
            <input
              type="text"
            ...
            />
            */}
            {/* Static Username Display - This will be part of the form row below, if needed as a static display, or the input will be used */}
            {/* 
            {profile?.username && (
