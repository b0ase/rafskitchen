      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-lg">
            ...
            <p className="text-3xl font-bold text-blue-400">{mockUser.projects}</p>
            <p className="text-gray-400 text-sm">Active projects</p>
          </div>
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-white mb-2">Teams</h3>
            <p className="text-3xl font-bold text-green-400">{mockUser.teams}</p>
            <p className="text-gray-400 text-sm">Team memberships</p>
          </div>
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-white mb-2">Member Since</h3>
            <p className="text-lg font-semibold text-purple-400">{mockUser.joinedDate}</p>
            <p className="text-gray-400 text-sm">Join date</p>
          </div>
        </div>

        {/* Profile Info */}
        <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-lg mb-8">
          ...
          <p className="text-gray-300 mb-4">{mockUser.bio}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gray-900 border border-gray-700 rounded-lg p-6 shadow-lg">
            ...
            <div className="space-y-3">
              <Link
                href="/myprojects"
                className="block w-full text-left px-4 py-2 text-blue-300 bg-blue-900/50 rounded-md hover:bg-blue-800/50 transition-colors"
              >
                View My Projects
              </Link>
              <Link
                href="/studio"
                className="block w-full text-left px-4 py-2 text-green-300 bg-green-900/50 rounded-md hover:bg-green-800/50 transition-colors"
              >
                Studio Dashboard
              </Link>
              <Link
                href="/token"
                className="block w-full text-left px-4 py-2 text-purple-300 bg-purple-900/50 rounded-md hover:bg-purple-800/50 transition-colors"
              >
                $RAFS Token
              </Link>
            </div>
        ...
        <div className="mt-8 bg-yellow-900/20 border border-yellow-600/30 rounded-lg p-6">
          ...
          <div className="mt-4">
            <Link
              href="/"
              className="inline-flex items-center px-4 py-2 bg-yellow-600 text-black rounded-md hover:bg-yellow-500 transition-colors font-medium"
            >
              ← Back to Home
            </Link>
          </div>
