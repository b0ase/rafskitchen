  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-white px-4 md:px-6 lg:px-8 pb-4 md:pb-6 lg:pb-8 overflow-x-hidden">
      <main className="flex-grow bg-black">
        ...
        </div> {/* Closes the div started at line 973 <div className="mt-10"> */}
      </div>   {/* Closes the div started at line 839 <div className="mx-auto bg-black"> */}
    </main>
  </div>     {/* Closes the div started at line 837 <div className="w-full min-h-screen ..."> */}
);
} 