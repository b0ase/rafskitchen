...
export default function ProfilePage() {
  ...
  const mockUser = {
    ...
    username: 'raf',
    bio: 'Welcome to your RafsKitchen dashboard! This is Raf\'s personalized workspace showing what your culinary-tech innovation hub would look like.',
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-black mb-2">Projects</h3>
            <p className="text-3xl font-bold text-cyan-600">{mockUser.projects}</p>
            <p className="text-gray-600 text-sm">Active projects</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-black mb-2">Teams</h3>
            <p className="text-3xl font-bold text-green-600">{mockUser.teams}</p>
            <p className="text-gray-600 text-sm">Team memberships</p>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg">
            <h3 className="text-lg font-semibold text-black mb-2">Member Since</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg mb-8">
          <div className="flex justify-between items-start mb-4">
            ...
            <button className="text-cyan-600 hover:text-cyan-700 flex items-center transition-colors">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-lg">
            ...
            <div className="space-y-3">
              <Link
                href="/myprojects"
                className="block w-full text-left px-4 py-2 text-cyan-700 bg-cyan-50 rounded-md hover:bg-cyan-100 transition-colors"
              >
                View My Projects
              </Link>
              <Link
                href="/studio"
                className="block w-full text-left px-4 py-2 text-green-700 bg-green-50 rounded-md hover:bg-green-100 transition-colors"
              >
                Studio Dashboard
              </Link>
              <Link
                href="/token"
                className="block w-full text-left px-4 py-2 text-purple-700 bg-purple-50 rounded-md hover:bg-purple-100 transition-colors"
              >
                $RAFS Token
              </Link>
            </div>
