...
export default function ProfilePage() {
  ...
  const handleUpdateProfile = async (e: FormEvent) => {
    ...
    const updates: Partial<Omit<Profile, 'avatar_url' | 'twitter_url' | 'linkedin_url' | 'github_url'> & { updated_at: string; twitter_url?: string | null; linkedin_url?: string | null; github_url?: string | null; }> = {
    ...
    if (newTwitterUrl) {
      updates.twitter_url = newTwitterUrl.trim();
    }
    if (newLinkedInUrl) {
      updates.linkedin_url = newLinkedInUrl.trim();
    }
    if (newGitHubUrl) {
      updates.github_url = newGitHubUrl.trim();
    }
