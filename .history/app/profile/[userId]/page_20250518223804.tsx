...
export default function UserProfilePage() {
  ...
  const fetchUserProfile = useCallback(async () => {
    ...
    if (skillsError) {
      ...
      // Ensure that we are correctly processing the potentially nested 'skills' object
      setUserSkills(skillsData?.map(us => us.skills).filter(skill => skill !== null && skill.id && skill.name) as Skill[] || []);
    }
