...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    const fetchInitialUser = async () => {
      ...
      setUser(fetchedUser);
      setLoading(false); // Clear loading after successful user fetch
    };
  ...
  useEffect(() => {
    const loadProfileAndSkills = async () => {
      ...
      setLoading(true); // Set loading states at the start of data fetch
    ...
    if (user?.id && pathname === '/profile') {
      ...
      setLoading(false); // Clear loading states immediately if no user
      setLoadingSkills(false);
      setLoadingUserTeams(false);
      setProfile(null);
      setSelectedSkills([]);
