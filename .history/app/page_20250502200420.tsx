        ...
        <section id="about" className="mb-16 md:mb-24 scroll-mt-20">
          ...
          <div className={`bg-white dark:bg-black p-6 md:p-8 border border-gray-200 dark:border-gray-800 shadow-md dark:shadow-xl 
            ...
            <div className="relative">
              ...
              <div className="absolute top-0 right-0 bg-gray-100 dark:bg-gray-900 px-4 py-3 border border-gray-200 dark:border-gray-700 text-xs text-gray-700 dark:text-gray-400 rounded shadow-md flex flex-col items-end min-w-[160px] max-w-[220px] z-10 space-y-2">
                <h3 className="font-semibold text-black dark:text-white mb-1 text-right">
                  $BOASE (BSV21)
                </h3>
                <a 
