    ...
    <div className="w-full max-w-none mx-auto my-12 px-2 md:px-8">
      <section className="w-full bg-gradient-to-br from-blue-900/80 to-gray-900/80 rounded-xl shadow-lg p-4 md:p-12 text-white">
        <div className="w-3/4 mx-auto text-center mb-12">
          <p className="text-lg mb-8">B0ASE is a full-service digital agency where creativity meets technical excellence. We specialize in transforming ideas into powerful digital experiences—from sophisticated web applications and mobile solutions to blockchain innovations and AI-driven platforms.</p>
        ...
        <div className="w-3/4 mx-auto">
          ...
          <p className="text-gray-300 text-center mb-8">
            Share your vision with us below. The more details you provide, the better we can understand and support your goals.
          </p>
          <ClientSignupForm />
        </div>
      </section>
