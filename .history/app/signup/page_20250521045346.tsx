...
export default function SignupPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-gray-300 flex flex-col items-center justify-center p-4">
      <section className="bg-black p-8 md:p-12 border border-gray-800 shadow-2xl rounded-lg text-center max-w-4xl w-full my-12">
        <div className="w-full mx-auto text-center mb-12">
          <h1 className="text-4xl font-extrabold text-white mb-8">Welcome to B0ASE.com</h1>
