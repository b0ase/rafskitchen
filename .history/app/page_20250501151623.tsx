        ...
        <section id="services" className="mb-16 scroll-mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(portfolioData.services).map(([key, service]) => (
              // Use light gray gradient and dark text for service cards
              <div key={key} className="bg-gradient-to-br from-gray-200 to-gray-300 text-gray-900 p-6 shadow-lg">
              ...
              return (
                <div key={project.id} className={cardStyle}>
                  ...
                  <div className="flex flex-col flex-grow mb-4 relative pt-2"> 
                    ...
                    {/* <p className={`mb-3 flex-grow ${descriptionStyle}`