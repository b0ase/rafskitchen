...
export default function TokenPage() {
  ...
  const features = [
    ...
    },
    {
      icon: FaExchangeAlt,
      title: 'Utility Token',
      description: 'Use RAF tokens for premium services, features, and platform transactions'
    },
    {
      icon: FaLock,
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 text-white py-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center mb-6">
            ...
            <div>
              <h1 className="text-4xl md:text-6xl font-bold">$RAFKITCHEN</h1>
              <p className="text-xl text-purple-100">The RafsKitchen Ecosystem Token</p>
            </div>
          </div>
          <p className="text-lg text-purple-200 max-w-3xl mx-auto">
            Power the future of tech innovation with RAF tokens. Participate in 
      ...
      <div className="bg-purple-600 text-white py-16 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-purple-100 mb-8">
            ...
            and be the first to know when RAF tokens become available.
          </p>
      ...
      <div className="bg-yellow-50 border-t border-yellow-200 py-8 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-yellow-700">
            This is a demonstration of the $RAFKITCHEN token page. All statistics 
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-gray-300 flex flex-col dark:bg-gradient-to-b dark:from-gray-950 dark:via-black dark:to-gray-950 dark:text-gray-300">
      <main className="flex-grow container mx-auto px-4 py-12 md:py-16 flex flex-col items-center">
        <div className="text-center mb-8">
            ...
            {/* Detailed regulatory description moved from landing page */}
            <p className="text-sm text-gray-400 dark:text-gray-400 mb-4 max-w-2xl mx-auto">
              $BOASE is a regulated share in Boase Corporation. Shares may be tokenized on any blockchain, and can be redeemed and reissued on any chain at the company's discretion.
            </p>
