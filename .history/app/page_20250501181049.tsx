    ...
    <div className="min-h-screen bg-black text-gray-300 font-sans">
      ...
      <main className="px-4 py-16">
        ...
        <section id="services" className="mb-16 scroll-mt-16">
          {/* Section Title */}
          <h2 className="text-3xl font-semibold mb-4 border-b border-gray-800 pb-2 text-white">Services</h2> {/* Reduced bottom margin */} 
          {/* Add General Pricing Info Paragraph */}
          <p className="text-gray-400 mb-8 text-sm md:text-base"> 
            Standard rates are typically around $100 per hour or per article for content creation. For more involved projects, daily rates range from $400 - $500. 
            Please note that UK VAT (20%) will be added where applicable. Fixed-price contracts for larger projects are available upon discussion.
          </p>
