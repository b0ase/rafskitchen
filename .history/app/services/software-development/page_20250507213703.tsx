  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">// Software Development</h1>
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-cyan-400">Our Software Solutions</h2>
      ...
      {/* Portfolio Showcase */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-cyan-400">Featured Projects</h2>
