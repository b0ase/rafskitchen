    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Link href="/projects/crypto-trading-platform" passHref legacyBehavior>
            <a className="block bg-black border border-gray-800 shadow-xl overflow-hidden hover:shadow-cyan-500/30 transition-shadow duration-300">
              <ProjectImage 
                ...
                projectId="crypto-trading-platform"
          ...
          <Link href="/projects/smart-contract-audit-tool" passHref legacyBehavior>
            <a className="block bg-black border border-gray-800 shadow-xl overflow-hidden hover:shadow-cyan-500/30 transition-shadow duration-300">
              <ProjectImage 
                service="software-development"
                projectId="smart-contract-audit-tool"
          ...
          <Link href="/projects/ai-analytics-dashboard" passHref legacyBehavior>
            <a className="block bg-black border border-gray-800 shadow-xl overflow-hidden hover:shadow-cyan-500/30 transition-shadow duration-300">
              <ProjectImage 
                service="software-development"
