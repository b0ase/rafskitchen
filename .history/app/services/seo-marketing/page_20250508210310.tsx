  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4"><span className="text-cyan-400">//</span> SEO & Digital Marketing</h1>
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-black p-6 border border-gray-800 shadow-xl flex flex-col">
            <div className="flex items-center mb-4">
              <FaHashtag className="text-white mr-3 text-xl" />
