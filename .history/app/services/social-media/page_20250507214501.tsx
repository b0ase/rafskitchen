  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">// Social Media Management</h1>
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-blue-400">Our Social Media Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaChartBar className="text-blue-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaFacebookF className="text-blue-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaInstagram className="text-blue-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaLinkedinIn className="text-blue-400 mr-3 text-xl" />
      ...
      {/* Case Studies */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-blue-400">Social Media Success Stories</h2>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={index} className="px-3 py-1 bg-gray-800 text-blue-400 text-xs rounded-full">
                      {tag}
                    </span>
                  ))}
                </div>
      ...
      <section className="px-4 md:px-8 py-8 mb-16 bg-gray-900">
        <h2 className="text-2xl font-bold mb-6 text-blue-400">Our Social Media Process</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {/* Client Testimonials */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-blue-400">Client Testimonials</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-6 rounded-lg relative">
            <div className="text-4xl text-blue-500 opacity-30 absolute top-4 left-4">"</div>
      ...
      {/* Platforms */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-blue-400">Platforms We Specialize In</h2>
