...
import { FaVideo, FaCamera, FaEdit, FaDrone, FaLightbulb, FaFilm } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">// Video Production & Photography</h1>
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-purple-400">Our Visual Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaVideo className="text-purple-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaCamera className="text-purple-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaEdit className="text-purple-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaDrone className="text-purple-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaLightbulb className="text-purple-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaFilm className="text-purple-400 mr-3 text-xl" />
      ...
      {/* Portfolio Showcase */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-purple-400">Featured Work</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((item) => (
            <div key={item} className="bg-gray-900 rounded-lg overflow-hidden">
              <div className="h-48 bg-gray-800 relative">
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900">
                  <span className="text-gray-600 text-lg">[Portfolio {item}]</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2">
                  {item === 1 && "Product Launch Video"}
                  {item === 2 && "Corporate Brand Photography"}
                  {item === 3 && "Event Highlight Reel"}
                </h3>
                <p className="text-gray-400 mb-3">
                  {item === 1 && "Cinematic product reveal video that generated over 100,000 views and contributed to a successful launch campaign."}
                  {item === 2 && "Complete visual identity photography package including team portraits, office environment, and product imagery."}
                  {item === 3 && "Dynamic event video capturing key moments, presentations, and attendee experiences for a major industry conference."}
                </p>
                <div className="flex flex-wrap gap-2">
                  {[
                    item === 1 ? ['Product', 'Cinematic', 'Marketing', 'Commercial'] : 
                    item === 2 ? ['Corporate', 'Photography', 'Branding', 'Portrait'] :
                    ['Event', 'Documentary', 'Highlights', 'Social Media']
                  ].map((tag, index) => (
                    <span key={index} className="px-3 py-1 bg-gray-800 text-purple-400 text-xs rounded-full">
                      {tag}
                    </span>
                  ))}
                </div>
      ...
      <section className="px-4 md:px-8 py-8 mb-16 bg-gray-900">
        <h2 className="text-2xl font-bold mb-6 text-purple-400">Our Production Process</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 border-l-2 border-purple-500">
      ...
      {/* Client Testimonials */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-purple-400">Client Testimonials</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-6 rounded-lg relative">
            <div className="text-4xl text-purple-500 opacity-30 absolute top-4 left-4">"</div>
      ...
      {/* Equipment */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-purple-400">Our Equipment</h2>
      ...
      <section className="px-4 md:px-8 py-12 text-center mb-8">
        <Link 
          href="/contact"
          className="inline-block bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-8 transition duration-200"
        >
          Get in Touch
        </Link>
      </section>
