      ...
      <main>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div key={service.id} className="bg-gray-900 p-6 rounded-lg shadow-xl hover:shadow-cyan-500/20 transition-all duration-300 ease-in-out flex flex-col transform hover:-translate-y-1">
              {/* 
              ...
              */}
              ...
              <div className="mt-auto pt-4 border-t border-gray-700">
                <Link 
                  href="/contact" // Assumes a contact page exists or will exist at /contact
