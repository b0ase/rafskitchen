    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Link href="/featured/ecommerce-platform" className="bg-black border border-gray-800 shadow-xl overflow-hidden cursor-pointer hover:border-sky-400 hover:bg-gray-800 transition-transform duration-150 transform hover:scale-105">
            <ProjectImage 
          ...
          <Link href="/featured/corporate-web-portal" className="bg-black border border-gray-800 shadow-xl overflow-hidden cursor-pointer hover:border-sky-400 hover:bg-gray-800 transition-transform duration-150 transform hover:scale-105">
            <ProjectImage 
              service="web-development"
          ...
          <Link href="/featured/progressive-web-app" className="bg-black border border-gray-800 shadow-xl overflow-hidden cursor-pointer hover:border-sky-400 hover:bg-gray-800 transition-transform duration-150 transform hover:scale-105">
            <ProjectImage 
              service="web-development"
