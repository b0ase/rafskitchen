...
export default function WebDevelopmentPage() {
  return (
    <div className="min-h-screen bg-gray-950 text-white p-4 md:p-8 lg:p-12 flex flex-col items-center">
      <header className="w-full max-w-4xl text-left mb-10 md:mb-12">
        <nav className="mb-6">
          <Link href="/services" className="text-cyan-400 hover:text-cyan-300 transition-colors text-sm">
            &larr; Back to All Services
          </Link>
        </nav>
        <h1 className="text-4xl md:text-5xl font-bold text-cyan-400 mb-6">// Web Development</h1>
        <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
          Our web development process focuses on creating high-performance, scalable, and visually appealing digital experiences. We leverage modern frameworks like Next.js and React, combined with best practices in SEO, accessibility, and user experience. From simple landing pages to complex web applications and e-commerce platforms, we tailor solutions to meet specific business goals.
        </p>
      </header>
      ...
      <footer className="w-full max-w-4xl text-center mt-16 md:mt-20 py-8 border-t border-gray-800">
