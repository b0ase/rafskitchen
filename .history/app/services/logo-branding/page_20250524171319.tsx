        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-black p-6 border border-gray-800 shadow-xl relative">
            ...
            <div className="relative z-10">
              <p className="text-gray-300 mb-4 italic">"The logo and brand identity RafsKitchen created for our company perfectly captures our vision and values. Their strategic approach to design has given us a brand that truly stands out in our industry."</p>
              <div>
          ...
          <div className="bg-black p-6 border border-gray-800 shadow-xl relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-300 mb-4 italic">"Our brand refresh by RafsKitchen has completely transformed how our customers perceive us. They respected our history while bringing our visual identity into the future. The results have exceeded our expectations."</p>
              <div>
          ...
          <div className="bg-black p-6 border border-gray-800 shadow-xl relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-300 mb-4 italic">"The comprehensive brand guidelines RafsKitchen developed have been invaluable as we've scaled our business. Their attention to detail and thoughtful design system has made maintaining brand consistency effortless."</p>
              <div>
