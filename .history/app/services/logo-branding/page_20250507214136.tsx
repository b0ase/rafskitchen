  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">// Logo Design & Branding</h1>
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-pink-400">Our Branding Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaPen className="text-pink-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaPalette className="text-pink-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaRulerCombined className="text-pink-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaSwatchbook className="text-pink-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaObjectGroup className="text-pink-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaGlobe className="text-pink-400 mr-3 text-xl" />
      ...
      {/* Portfolio Showcase */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-pink-400">Featured Brand Work</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[1, 2, 3].map((item) => (
            <div key={item} className="bg-gray-900 rounded-lg overflow-hidden">
              <div className="h-48 bg-gray-800 relative">
                <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900">
                  <span className="text-gray-600 text-lg">[Brand Sample {item}]</span>
                </div>
              </div>
              <div className="p-6">
                <h3 className="font-bold text-xl mb-2">
                  {item === 1 && "Tech Startup Rebrand"}
                  {item === 2 && "Luxury Product Branding"}
                  {item === 3 && "Nonprofit Visual Identity"}
                </h3>
                <p className="text-gray-400 mb-3">
                  {item === 1 && "Complete rebrand for a growing tech company, including logo redesign, visual identity system, and application across digital platforms."}
                  {item === 2 && "Sophisticated branding for a high-end consumer product, featuring elegant logo design and premium packaging concepts."}
                  {item === 3 && "Accessible and impactful branding for a community-focused nonprofit, including logo, color system, and marketing materials."}
                </p>
                <div className="flex flex-wrap gap-2">
                  {[
                    item === 1 ? ['Logo', 'Identity System', 'Digital', 'Tech'] : 
                    item === 2 ? ['Luxury', 'Packaging', 'Product', 'Retail'] :
                    ['Nonprofit', 'Community', 'Print', 'Accessible']
                  ].map((tag, index) => (
                    <span key={index} className="px-3 py-1 bg-gray-800 text-pink-400 text-xs rounded-full">
                      {tag}
                    </span>
                  ))}
                </div>
      ...
      <section className="px-4 md:px-8 py-8 mb-16 bg-gray-900">
        <h2 className="text-2xl font-bold mb-6 text-pink-400">Our Branding Process</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 border-l-2 border-pink-500">
      ...
      {/* Client Testimonials */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-pink-400">Client Testimonials</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-6 rounded-lg relative">
            <div className="text-4xl text-pink-500 opacity-30 absolute top-4 left-4">"</div>
      ...
      {/* Tools & Methods */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-pink-400">Design Tools & Methods</h2>
      ...
      <section className="px-4 md:px-8 py-12 text-center mb-8">
        <Link 
          href="/contact"
          className="inline-block bg-pink-600 hover:bg-pink-700 text-white font-bold py-3 px-8 transition duration-200"
        >
          Get in Touch
        </Link>
      </section>
