...
// Try relative paths for components and data - COMMENTED OUT FOR TESTING
// import { portfolioData } from '../../lib/data'; // Relative path
...
export default function ServicePage() {
    ...
    // Find the service data matching the slug - COMMENTED OUT FOR TESTING
    // const service = portfolioData.services.find(s => s.slug === slug);

    // Handle case where service is not found - COMMENTED OUT FOR TESTING
    // if (!service) {
    //     return (
    ...
    // Render the service details - TEMPORARY PLACEHOLDER
    return (
        <div>
            <h1>Testing Service Page</h1>
            <p>Slug: {slug}</p>
        </div>
    );

    // Original rendering code - COMMENTED OUT FOR TESTING
    // return (
    //     <div className="min-h-screen flex flex-col dark:bg-gradient-to-b dark:from-gray-950 dark:via-black dark:to-gray-950 dark:text-gray-300">
    //         {/* <Header /> */}
