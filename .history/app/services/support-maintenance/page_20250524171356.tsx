        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-6 rounded-lg relative">
            ...
            <div className="relative z-10">
              <p className="text-gray-300 mb-4 italic">"The ongoing maintenance from RafsKitchen has been crucial to our business. Their proactive support helps us avoid downtime and keeps our e-commerce platform running smoothly even during peak seasons."</p>
              <div>
          ...
          <div className="bg-gray-900 p-6 rounded-lg relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-300 mb-4 italic">"We switched to RafsKitchen's Professional support plan after experiencing recurring issues with our previous provider. Their response times are impressive, and they've completely eliminated the security concerns we were having."</p>
              <div>
          ...
          <div className="bg-gray-900 p-6 rounded-lg relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-300 mb-4 italic">"As an enterprise with critical applications, we can't afford any downtime. RafsKitchen's Enterprise support package gives us peace of mind knowing our systems are being monitored 24/7 and any issues are resolved immediately."</p>
              <div>
