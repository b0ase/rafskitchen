  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4">// Ongoing Support & Maintenance</h1>
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-orange-400">Our Support Services</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaTools className="text-orange-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaServer className="text-orange-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaShieldAlt className="text-orange-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaRocket className="text-orange-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaCloudUploadAlt className="text-orange-400 mr-3 text-xl" />
          ...
          <div className="bg-gray-900 p-6 rounded-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaChartLine className="text-orange-400 mr-3 text-xl" />
      ...
      {/* Support Plans */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-orange-400">Support Plans</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-900 rounded-lg overflow-hidden border border-gray-800">
            <div className="bg-gray-800 p-6">
              ...
              <p className="text-2xl font-bold mt-4 text-orange-400">£250<span className="text-sm font-normal text-gray-400">/month</span></p>
            </div>
            <div className="p-6">
          ...
          {/* Professional Plan */}
          <div className="bg-gray-900 rounded-lg overflow-hidden border border-orange-500 transform scale-105 shadow-xl">
          ...
          <div className="bg-gray-900 rounded-lg overflow-hidden border border-gray-800">
            <div className="bg-gray-800 p-6">
              ...
              <p className="text-2xl font-bold mt-4 text-orange-400">Custom<span className="text-sm font-normal text-gray-400">/month</span></p>
            </div>
            <div className="p-6">
              <ul className="space-y-3">
                {[
      ...
      {/* Client Testimonials */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-orange-400">Client Testimonials</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gray-900 p-6 rounded-lg relative">
            <div className="text-4xl text-orange-500 opacity-30 absolute top-4 left-4">"</div>
      ...
      <section className="px-4 md:px-8 py-8 mb-16 bg-gray-900">
        <h2 className="text-2xl font-bold mb-6 text-orange-400">Our Support Process</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 border-l-2 border-orange-500">
      ...
      {/* Technologies */}
      <section className="px-4 md:px-8 py-8 mb-16">
        <h2 className="text-2xl font-bold mb-6 text-orange-400">Technologies We Support</h2>
      ...
      <section className="px-4 md:px-8 py-12 text-center mb-8">
        <Link 
          href="/contact"
          className="inline-block bg-orange-600 hover:bg-orange-700 text-white font-bold py-3 px-8 transition duration-200"
        >
          Get in Touch
        </Link>
      </section>
