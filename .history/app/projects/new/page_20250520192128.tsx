      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="bg-gray-900 shadow-2xl rounded-lg p-6 sm:p-8 md:p-10 border border-gray-700/50 relative">
          ...
          <div className="flex justify-between items-start mb-10">
            ...
            {/* Right Part: Container for GitHub and Create Idea buttons */}
            <div className="flex items-start space-x-4">
              ...
              {/* Sticky Create Idea Button Wrapper */}
              <div className="z-10" style={{ position: 'sticky', top: '1.5rem' }}> {/* Adjust top for desired sticky offset from viewport top */}
                <button
                  type="button"
