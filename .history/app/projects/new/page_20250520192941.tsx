        ...
        <div className="bg-gray-900 shadow-2xl rounded-lg p-6 sm:p-8 md:p-10 border border-gray-700/50 relative">
          ...
          <div className="flex justify-between items-start mb-10">
            ...
            <div className="flex items-start space-x-4">
              {/* Sticky Create Idea Button Wrapper - remains top right of card */}
          ...
          <form onSubmit={handleSubmit} id="project-creation-form" className="space-y-8">
            {/* Moved Social Links Section to the top of the form */}
            <div className="space-y-4 pb-4 border-b border-gray-800"> {/* Added bottom border for separation */}
            ...
            {/* Moved Team and Token Options Section after Socials */}
            <div className="space-y-4 pb-4 border-b border-gray-800"> {/* Added bottom border */}
              <h3 className="text-md font-medium text-gray-300">Project Extras (Optional)</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="relative flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-xs text-gray-500">A new team will be created with the same name as your project idea.</p>
                  </div>
                </div>
                <div className="relative flex items-start">
                  <div className="flex items-center h-5">
                  ...
                  <div className="ml-3 text-sm">
                    <label htmlFor="addProjectToken" className="font-medium text-gray-300 flex items-center">
                       <FaCoins className="w-5 h-5 mr-2 text-yellow-400" /> Launch a Token for this Project
                    </label>
                    <p className="text-xs text-gray-500">A token will be conceptualized with a 6-letter ticker (e.g., $IDEA1).</p>
                  </div>
                </div>
              </div>
            </div>

            {/* Original form fields start here */}
            <div>
