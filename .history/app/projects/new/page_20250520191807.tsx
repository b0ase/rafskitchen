...
export default function NewProjectPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-950 via-black to-gray-950 text-gray-300 py-12 relative">
      {/* Sticky Create Project Button */}
      <div className="absolute top-10 right-10 z-50" style={{ position: 'sticky', top: '2.5rem' }}> {/* Adjust top as needed */}
        <button
          type="button" // Important: type="button" if not submitting form directly here
          onClick={() => (document.getElementById('project-creation-form') as HTMLFormElement)?.requestSubmit()} // Programmatically submit form
