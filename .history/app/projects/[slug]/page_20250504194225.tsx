                  ...
                  if (phase.key === 'now') {
                    ...
                    return (
                      <div key={phase.key} className="bg-gray-900 p-4 rounded shadow flex flex-col">
                        ...
                        >
                          {/* Using a plain image instead of an iframe to avoid the b0ase.com navbar issue */}
                          <div className="w-full h-full flex items-center justify-center">
                            <img 
                              src={`/images/clientprojects/${projectSlug}/preview.png`} 
                              alt={`${projectSlug} Preview`}
                              className="max-w-full max-h-full object-contain"
                              onError={(e) => {
                                const target = e.target as HTMLImageElement;
                                target.onerror = null;
                                target.src = '/images/preview-placeholder.png';
                              }}
                            />
                          </div>
                        </div>
