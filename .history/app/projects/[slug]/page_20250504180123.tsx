                  ...
                  if (phase.key === 'now') {
                    ...
                    return (
                      <div key={phase.key} className="bg-gray-900 p-4 rounded shadow flex flex-col">
                        ...
                        {/* Preview Panel - MODIFIED for Live Site iframe */}
                        <div className="mb-4 aspect-video bg-gray-800 rounded flex items-center justify-center text-gray-500 overflow-hidden border border-gray-700">
                          {/* Use iframe for the live site */}
                          <iframe
                             // Construct the live URL - Using confirmed HTTPS URL
                             src="https://robust-ae.com/" // Hardcoding for now, or use a projectData field if available
