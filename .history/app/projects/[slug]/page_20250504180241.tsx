                  ...
                  if (phase.key === 'now') {
                    ...
                    return (
                      <div key={phase.key} className="bg-gray-900 p-4 rounded shadow flex flex-col">
                        ...
                        {/* Preview Panel - MODIFIED for Live Site iframe with Zoom-out */}
                        <div className="mb-4 aspect-video bg-gray-700 rounded flex items-center justify-center text-gray-500 overflow-hidden border border-gray-700 relative">
