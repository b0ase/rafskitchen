...
export default function ProjectDetailPage({ params }: ProjectDetailProps) {
  ...
  // Custom content for robust-ae.com
  const isRobust = project.slug === 'robust-ae-com';
      ...
      <main className="flex-grow container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="bg-white dark:bg-black p-6 md:p-8 border border-gray-200 dark:border-gray-800 shadow-md dark:shadow-xl mb-8">
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed whitespace-pre-line">
                {isRobust ? (
                  <>
                    <strong>Robust Engineering Platform</strong> is a next-generation digital hub for engineering innovation, project delivery, and client collaboration. Built for George Haworth's forward-thinking engineering business, Robust-AE.com empowers clients and partners to achieve more through technology.
                    <br /><br />
                    <strong>Key Features:</strong>
                    <ul className="list-disc pl-6 mt-2 mb-4 text-gray-600 dark:text-gray-300">
