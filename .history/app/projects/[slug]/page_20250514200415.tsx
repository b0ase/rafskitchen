...
export default function ProjectPage({ params, searchParams }: { params: { slug: string }, searchParams?: { [key: string]: string | string[] | undefined } }) {
  ...
  // Define phaseLabels for treatments if it's used there (or remove if not)
  ...
  // Before the main return, determine if the manage members button should show
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <h1 className="text-4xl md:text-5xl font-bold text-sky-400 break-all">
                  ...
                  <Link href={`/myprojects/${projectSlug}/edit`} passHref legacyBehavior>
                     <a className="text-sky-500 hover:text-sky-400 ml-3 text-2xl inline-block align-middle" title="Edit Project Details (Admin)">
                        <FaEdit />
                     </a>
                  </Link>
                </h1>
