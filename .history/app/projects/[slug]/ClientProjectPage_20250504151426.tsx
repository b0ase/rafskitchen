      ...
      <div className="mb-6 flex flex-wrap justify-end gap-4">
          {projectData?.preview_url && (
            <Link href={projectData.preview_url} passHref legacyBehavior>
              <a 
                ...
                className="inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded transition duration-200"
              >
          ...
          {projectData?.github_repo_url && (
              <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-4 rounded transition duration-200"
              >
