                          ...
                          {projectData.website ? (
                            <iframe
                              ...
                              onError={(e) => {
                                ...
                                // Handle potential iframe loading errors (e.g., CORS, 404)
                                console.error(`Error loading iframe for ${projectData.website}`, e);
                                // Consider replacing the iframe with an error message here
                                // Example: target.parentElement.innerHTML = '<p class="text-red-500">Could not load live site preview.</p>';
                              }}
                            />
                          ) : (
                            <div className="w-full h-full flex items-center justify-center bg-gray-800">
                              <p className="text-gray-400 italic">No live website URL specified for this project.</p>
                            </div>
                          )}
                        </div>
