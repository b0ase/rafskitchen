...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 flex flex-col overflow-x-hidden w-full">
      <main className="flex-grow w-full">
        ...
        */}
        ...
        <section id="about" className="mb-16 md:mb-24 scroll-mt-20 overflow-x-hidden">
        ...
        <section id="services" className="mb-16 md:mb-24 scroll-mt-20 overflow-x-hidden">
        ...
        <section id="skills" className="mb-16 md:mb-24 scroll-mt-20 overflow-x-hidden">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
            Technical Skills
          </h2>
          <div className="bg-gray-50 p-8 md:p-12 border border-gray-200 shadow-xl rounded-2xl">
        ...
        <section id="projects" className="mb-16 md:mb-24 scroll-mt-20 overflow-x-hidden">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
            Featured Projects
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <section id="contact" className="mb-16 scroll-mt-20 overflow-x-hidden">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center">
              Get In Touch
          </h2>
