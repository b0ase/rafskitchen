        ...
        <section id="development" className="mb-16 md:mb-24 scroll-mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {projects.filter(p => p.type === 'github').map((project) => (
                    <div key={project.id} className="bg-white/10 backdrop-blur-xl p-6 border border-white/20 shadow-xl rounded-2xl flex flex-col transition-all duration-300 hover:transform hover:scale-105 hover:bg-white/20">
                        ...
                        {project.status && (
                           ...
                           project.status === 'Archived' ? 'bg-gray-500/20 border-gray-400/30 text-gray-300' : 
