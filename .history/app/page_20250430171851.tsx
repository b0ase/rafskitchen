        ...
        <section id="projects" className="mb-16 scroll-mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {portfolioData.projects.map((project) => (
              <div key={project.id} className="bg-gray-900 p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
                {/* Project Status Badge */}
                <span className="absolute top-3 right-3 bg-gray-700 text-gray-300 text-xs font-medium px-2.5 py-0.5 rounded-full">{project.status}</span>
                ...
                <div className="mt-auto pt-4 border-t border-gray-800 flex justify-between items-center gap-4">
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className={`text-sm px-3 py-1 rounded ${project.tokenMarketUrl === '#' 
