...
const portfolioData = {
  ...
  projects: [
    // Add b0ase.com platform entry first
    {
      ...
      tech: ['Next.js', 'React', 'Tailwind CSS'], // Example tech
      githubUrl: 'https://github.com/b0ase/b0ase.com', // Main repo URL (update if different)
      xUrl: 'https://x.com/b0ase', // Main X profile
      notionUrl: '#', // Placeholder
      tokenName: '$BOASE', // The main token
      tokenMarketUrl: 'https://1sat.market/market/bsv21/c3bf2d7a4519ddc633bc91bbfd1022db1a77da71e16bb582b0acc0d8f7836161_1', // Provided link
      tokenPlatform: 'BSV21', // Inferred from link
      status: 'Live Platform',
      type: 'domain' // Treat as a primary domain project
    },
