...
const portfolioData = {
  ...
  services: {
    webDevelopment: { title: 'Web Development', description: 'Building responsive, performant websites and web applications using modern technologies. (Est. Rate: £X/hr | £Y/day)' },
    journalism: { title: 'Content & Copywriting', description: 'Crafting compelling narratives, articles, and website copy tailored to your audience. (Est. Rate: £X/hr | £Y/day)' },
    filmmaking: { title: 'Video Production', description: 'From concept and shooting to editing and final delivery for promotional or creative needs. (Est. Rate: £X/hr | £Y/day)' },
    logoDesign: { title: 'Logo Design & Branding', description: 'Crafting unique logos and visual identities that effectively represent your brand. (Est. Rate: £X/hr | £Y/day)' },
    photography: { title: 'Photography', description: 'High-quality photography solutions for events, products, portraits, and more. (Est. Rate: £X/hr | £Y/day)' },
    seo: { title: 'SEO & Digital Marketing', description: 'Optimizing online presence and content strategy to drive organic growth. (Est. Rate: £X/hr | £Y/day)' },
    socialMedia: { title: 'Social Media Management', description: 'Developing strategies, creating content, and managing social media presence to grow engagement and reach. (Est. Rate: £X/hr | £Y/day)' },
    consulting: { title: 'Technical Consulting', description: 'Providing expert advice and strategy for your digital projects and technical challenges. (Est. Rate: £X/hr | £Y/day)' }, 
    support: { title: 'Ongoing Support & Maintenance', description: 'Reliable support packages to keep your digital assets running smoothly and securely. (Est. Rate: £X/hr | £Y/day)' }
  }
};
  ...
  return (
    <div className="min-h-screen bg-black text-gray-300 font-sans">
      ...
      <main className="px-4 py-16">
        ...
        <section 
          id="about" 
          className="mb-16 scroll-mt-16 p-6 md:p-8 bg-gray-900 shadow-lg border border-gray-700"
        >
        ...
        <section id="services" className="mb-16 scroll-mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(portfolioData.services).map(([key, service]) => (
              // Apply dark background, border, and text
              (<div key={key} className="bg-gray-900 p-6 shadow-lg border border-gray-700">
        ...
        {/* ===== Contact Section - Apply Dark Theme ===== */}
        <section 
          id="contact" 
          className="mb-16 scroll-mt-16 p-6 md:p-8 bg-gray-900 shadow-lg border border-gray-700"
        >
