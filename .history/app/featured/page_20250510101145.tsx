      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {featuredWorks.map((work) => (
            <Link key={work.title} href={work.href} className="block bg-gray-900 border border-white rounded-lg shadow-lg p-6 hover:border-sky-400 transition-colors duration-150">
