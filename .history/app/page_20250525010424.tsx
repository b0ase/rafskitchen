        ...
        <section id="hero" className="py-16 md:py-24 text-center"> {/* Adjusted padding */}
          <div className="max-w-6xl mx-auto px-4"> {/* Overall hero container */} 
            <div className="max-w-4xl mx-auto"> {/* Container for text content */}
              <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-8"> {/* Increased margin-bottom for spacing */}
                <span className="block text-6xl md:text-8xl font-extrabold bg-gradient-to-r from-cyan-500 to-blue-600 bg-clip-text text-transparent mb-3 md:mb-4">
                  RAFSKITCHEN
                </span>
