        ...
        <div className="space-y-12">
          <section className="p-8 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl">
            ...
            <a
              ...
              className="inline-block px-4 py-2 bg-sky-700 hover:bg-sky-600 text-white text-sm font-medium rounded-md shadow-sm transition-colors duration-150"
            >
          ...
          <section className="p-8 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block px-4 py-2 bg-purple-700 hover:bg-purple-600 text-white text-sm font-medium rounded-md shadow-sm transition-colors duration-150"
            >
