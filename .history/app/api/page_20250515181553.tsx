      ...
      {!isLoading && !error && (
        <div className="space-y-12">
          <section className="prose prose-invert prose-sm sm:prose-base lg:prose-lg xl:prose-xl max-w-none p-8 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl">
            <h2 className="!text-sky-400 border-b-2 !border-sky-500 pb-2 mb-6">Internal API Design (Test)</h2>
            <ReactMarkdown>{`# Test Heading\n\nThis is a **test** paragraph.\n\n- Item 1\n- Item 2`}</ReactMarkdown>
          </section>

          <section className="prose prose-invert prose-sm sm:prose-base lg:prose-lg xl:prose-xl max-w-none p-8 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl">
            <h2 className="!text-purple-400 border-b-2 !border-purple-500 pb-2 mb-6">Model Context Protocol (MPC) Design (Test)</h2>
            <ReactMarkdown>{`## Another Test\n\n*Italic* and [a link](https://example.com)`}</ReactMarkdown>
          </section>
        </div>
      )}
    </div>
