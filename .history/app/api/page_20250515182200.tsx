    ...
    <div className="container mx-auto px-4 py-10 text-gray-200 bg-gray-950 min-h-screen">
      ...
      {!isLoading && !error && (
        <div className="space-y-12">
          <section className="prose prose-invert max-w-none p-8 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl">
            <h2 className="!text-sky-400 border-b-2 !border-sky-500 pb-2 mb-6">Internal API Design</h2>
            <ReactMarkdown>{internalApiMarkdown}</ReactMarkdown>
          </section>

          <section className="prose prose-invert prose-sm sm:prose-base lg:prose-lg xl:prose-xl max-w-none p-8 bg-gray-800 border border-gray-700 rounded-xl shadow-2xl">
            <h2 className="!text-purple-400 border-b-2 !border-purple-500 pb-2 mb-6">Model Context Protocol (MPC) Design</h2>
