    ...
    <div className="container mx-auto px-4 py-10 text-gray-200 bg-gray-950 min-h-screen">
      ...
      <div className="mb-10 flex flex-wrap justify-center gap-4">
        <a
          ...
          className="inline-block px-6 py-3 bg-sky-700 hover:bg-sky-600 text-white font-semibold rounded-lg shadow-md transition-colors duration-150"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-block px-6 py-3 bg-purple-700 hover:bg-purple-600 text-white font-semibold rounded-lg shadow-md transition-colors duration-150"
        >
