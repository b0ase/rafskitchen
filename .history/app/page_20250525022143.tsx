...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 flex flex-col overflow-x-hidden w-full max-w-full" style={{maxWidth: '100vw'}}>
      <main className="flex-grow w-full max-w-full overflow-x-hidden">
        {/* START - Updated Hero Section */}
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 md:py-20 px-4 text-center overflow-x-hidden w-full">
          <div className="max-w-4xl mx-auto w-full">
            <div className="flex items-center justify-center gap-4 mb-6">
              <div className="p-3 sm:p-4 bg-gradient-to-br from-purple-500 to-teal-400 rounded-lg shadow-lg">
                <FaUtensils className="text-white text-2xl sm:text-3xl" />
              </div>
              <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold break-words word-break">
                RAFSKITCHEN
              </h1>
            </div>
            <p className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-medium mb-10 text-blue-100 break-words word-break">
              Software Development Studio
            </p>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-200 mx-auto break-words word-break">
              Open-source
        ...
        <section id="platform-features" className="py-16 md:py-24 bg-gray-50 overflow-x-hidden w-full px-4 sm:px-6 lg:px-8">
        ...
        */}
        ...
        <section id="about" className="mb-16 md:mb-24 scroll-mt-20 overflow-x-hidden w-full px-4 sm:px-6 lg:px-8">
          <div className={`relative bg-gray-50 p-8 md:p-12 border border-gray-200 shadow-xl rounded-2xl transition-all duration-700 ease-in-out max-w-6xl mx-auto ${isAboutVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
