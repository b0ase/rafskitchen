        ...
        <section id="about" className="mb-16 md:mb-24 scroll-mt-20">
          ...
          <div className={`relative bg-gray-50 p-8 md:p-12 border border-gray-200 shadow-xl rounded-2xl transition-all duration-700 ease-in-out ${isAboutVisible ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-10'}`}>
            ...
            <div className="relative z-10">
              <h1 className="relative text-4xl md:text-6xl text-gray-900 mb-6 font-bold min-h-[3rem] bg-gradient-to-r from-purple-600 to-teal-600 bg-clip-text text-transparent">
              ...
              <p className="relative text-xl md:text-2xl text-purple-700 mb-6 font-medium">
            ...
            <div className="absolute top-6 right-6 bg-gradient-to-r from-purple-600 to-teal-600 px-4 py-3 rounded-xl text-white shadow-xl border border-gray-200 z-20">
              <a 
          ...
          <div className="bg-gray-50 p-8 md:p-12 border border-gray-200 shadow-xl rounded-2xl">
            <div className="flex flex-wrap gap-3">
              {portfolioData.skills.technical.map((skill) => (
                <span 
                  key={skill} 
                  className="inline-block bg-gradient-to-r from-purple-500/10 to-teal-500/10 text-gray-900 px-4 py-2 rounded-full text-sm font-medium border border-gray-200 hover:bg-gray-100 transition-all duration-300 hover:scale-105"
                >
                  {skill}
                </span>
              ))}
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.slice(0, 3).map((tech) => (
                    <span 
                      key={tech} 
                      className="text-xs bg-purple-500/10 text-purple-700 px-2 py-1 rounded-md border border-purple-200"
                    >
                      {tech}
                    </span>
                  ))}
        ...
        <section id="development" className="mb-16 md:mb-24 scroll-mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {projects.filter(p => p.type === 'github').map((project) => (
                    <div key={project.id} className="bg-gray-50 p-6 border border-gray-200 shadow-xl rounded-2xl flex flex-col transition-all duration-300 hover:transform hover:scale-105 hover:bg-gray-100">
                        ...
                        {project.status && (
                           ...
                           ${project.status === 'Live' ? 'bg-green-100 border-green-300 text-green-800' : 
                           project.status === 'Archived' ? 'bg-gray-100 border-gray-300 text-gray-800' : 
                  ...
                  {project.githubUrl && project.githubUrl !== '#' && (
                    <a href={project.githubUrl} target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-gray-900 transition-colors" title="View Repository">
                      <FaGithub size={16}/>
                    </a>
                  )}
        ...
        <section id="contact" className="mb-16 scroll-mt-20">
          ...
          <div className="bg-gray-50 p-8 md:p-12 border border-gray-200 shadow-xl rounded-2xl text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link 
                href="/signup"
                className="inline-flex items-center px-8 py-4 bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold rounded-xl border border-gray-200 hover:border-gray-300 transition-all duration-300 transform hover:scale-105"
              >
