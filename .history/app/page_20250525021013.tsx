  ...
  return (
    <div className="min-h-screen bg-white text-gray-800 flex flex-col overflow-x-hidden">
      <main className="flex-grow">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16 md:py-20 px-4 text-center overflow-x-hidden">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold mb-6 break-words">
              RAFSKITCHEN
            </h1>
            <p className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-medium mb-10 text-blue-100 break-words">
              Software Development Studio
            </p>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-blue-200 mx-auto break-words">
              Open-source
        ...
        <section id="platform-features" className="py-16 md:py-24 bg-gray-50 overflow-x-hidden">
