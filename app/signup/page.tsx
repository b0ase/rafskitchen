...
export default function SignupPage() {
  return (
    <div className="w-full max-w-none mx-auto my-12 px-2 md:px-8">
      <section className="w-full bg-gradient-to-br from-blue-900/80 to-gray-900/80 rounded-xl shadow-lg p-4 md:p-12 text-white text-center">
        ...
        <p className="text-md text-blue-200 max-w-2xl mx-auto mb-8">We're passionate about partnering with founders, startups, and established brands to create digital experiences that inspire and deliver results. Share your ideas with us—no project is too big or too small. We can't wait to help you make it real.</p>
