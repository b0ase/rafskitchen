...
import {
  FaUserCircle, FaBookOpen, FaTasks, FaCalendarAlt, FaSignOutAlt, FaCog, FaDollarSign, FaChartLine, FaLightbulb, FaListAlt, FaBullseye, FaChalkboardTeacher, FaRoute, FaSearchDollar
} from 'react-icons/fa';
...
export default function UserSidebar() {
  ...
  const navLinks: NavLink[] = [
    { title: 'Studio', href: '/studio', icon: FaCog },
