...
export default function TokenPage() {
  return (
    <div className="min-h-screen bg-black text-gray-300 font-sans flex flex-col">
      <Header />
      <main className="flex-grow container px-4 py-16 max-w-3xl mx-auto"> {/* Centered content column */}
        ...
        <div className="bg-gray-900 p-6 md:p-8 shadow-lg mb-8">
          ...
          <p className="mb-4 leading-relaxed">
            The {tokenDetails.name} token represents a stake in the b0ase.com project incubator and its associated developments. 
            It serves as the primary mechanism for funding ongoing work and distributing potential revenue.
          </p>
          <p className="mb-4 leading-relaxed">
