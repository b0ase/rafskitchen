  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4"><span className="text-cyan-600">//</span> Video Production & Photography</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaVideo className="text-black mr-3 text-xl" />
              <h3 className="font-semibold text-xl">Promotional Videos</h3>
            </div>
            <p className="text-gray-600 flex-grow">Engaging videos that showcase your brand, products, or services with professional storytelling and high production value.</p>
          </div>
          
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaCamera className="text-black mr-3 text-xl" />
              <h3 className="font-semibold text-xl">Product Photography</h3>
            </div>
            <p className="text-gray-600 flex-grow">High-quality product images for e-commerce, catalogs, and marketing materials with perfect lighting and composition.</p>
          </div>
          
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaEdit className="text-black mr-3 text-xl" />
              <h3 className="font-semibold text-xl">Post-Production</h3>
            </div>
            <p className="text-gray-600 flex-grow">Professional editing, color grading, and visual effects that elevate your video content to a cinematic level.</p>
          </div>
          
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaPlane className="text-black mr-3 text-xl" />
              <h3 className="font-semibold text-xl">Aerial Photography</h3>
            </div>
            <p className="text-gray-600 flex-grow">Breathtaking drone footage and photography that provides unique perspectives for real estate, events, and landscape showcases.</p>
          </div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            ...
            <p className="text-gray-600 flex-grow">Strategic visual concept development that aligns with your brand identity and achieves your specific marketing objectives.</p>
          </div>
          
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaFilm className="text-black mr-3 text-xl" />
              <h3 className="font-semibold text-xl">Corporate Videos</h3>
            </div>
            <p className="text-gray-600 flex-grow">Professional corporate videos including company profiles, interviews, event documentation, and internal communication videos.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 md:px-8 py-8 mb-16 bg-gray-50 border border-gray-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 border-l-2 border-cyan-500">
            ...
            <p className="text-gray-600">We begin by understanding your objectives and developing a creative concept that aligns with your brand and messaging.</p>
          </div>
          
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">2. Pre-Production</h3>
            <p className="text-gray-600">Detailed planning including storyboarding, location scouting, talent casting, and equipment preparation ensures smooth execution.</p>
          </div>
          
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">3. Production</h3>
            <p className="text-gray-600">Professional filming or photography session with experienced crew, high-end equipment, and meticulous attention to detail.</p>
          </div>
          
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">4. Post-Production</h3>
            <p className="text-gray-600">Expert editing, color grading, sound design, and visual effects to create a polished final product that exceeds expectations.</p>
          </div>
          
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">5. Review & Refinement</h3>
            <p className="text-gray-600">Collaborative review process with opportunities for feedback and refinements to ensure the final result meets your vision.</p>
          </div>
          
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">6. Delivery & Distribution</h3>
            <p className="text-gray-600">Final delivery in optimal formats for your intended platforms, with guidance on effective distribution strategies if needed.</p>
          </div>
        </div>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 border border-gray-200 shadow-lg relative">
            ...
            <div className="relative z-10">
              <p className="text-gray-700 mb-4 italic">"B0ASE's video production team transformed our vision into a stunning visual story. The quality of the final product far exceeded our expectations and helped us establish a strong brand presence."</p>
              <div>
                <p className="font-semibold text-black">Jonathan Peters</p>
                <p className="text-gray-600 text-sm">Marketing Director, Innovate Tech</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-700 mb-4 italic">"The product photography B0ASE created for our e-commerce store has dramatically improved our conversion rates. Their attention to detail and ability to highlight our products' best features is remarkable."</p>
              <div>
                <p className="font-semibold text-black">Emily Watson</p>
                <p className="text-gray-600 text-sm">Founder, Artisan Goods</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-700 mb-4 italic">"We hired B0ASE to document our annual conference, and the highlight video they produced perfectly captured the energy and key moments. It's become an invaluable marketing asset for our next event."</p>
              <div>
                <p className="font-semibold text-black">Daniel Kim</p>
                <p className="text-gray-600 text-sm">Event Coordinator, Global Summits</p>
              </div>
            </div>
          </div>
        </div>
