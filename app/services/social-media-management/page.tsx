        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 border border-gray-200 shadow-lg relative">
            ...
            <div className="relative z-10">
              <p className="text-gray-700 mb-4 italic">"B0ASE completely transformed our social media presence. Their strategic approach and creative content has exponentially increased our engagement and following, translating directly to increased sales."</p>
              <div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-700 mb-4 italic">"Working with B0ASE on our LinkedIn strategy has been game-changing for our B2B sales pipeline. Their content approach has positioned us as thought leaders in our industry and significantly increased qualified leads."</p>
              <div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg relative">
            <div className="text-4xl text-cyan-500 opacity-30 absolute top-4 left-4">"</div>
            <div className="relative z-10">
              <p className="text-gray-700 mb-4 italic">"The B0ASE team not only manages our social media but has built a genuine community around our brand. Their engagement strategies and authentic approach has created a loyal following that truly values our products."</p>
              <div>
