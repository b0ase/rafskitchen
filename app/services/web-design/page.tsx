  ...
  return (
    <div className="min-h-screen bg-white text-black">
      ...
      <header className="w-full px-4 md:px-8 py-8">
        <h1 className="text-3xl md:text-4xl font-bold mb-4"><span className="text-cyan-600">//</span> Website Design</h1>
      ...
      <section className="px-4 md:px-8 py-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            ...
            <p className="text-gray-600 flex-grow">Unique website designs tailored to your brand identity, target audience, and specific business goals.</p>
          </div>
          
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaDesktop className="text-black mr-3 text-xl" />
              <h3 className="font-semibold text-xl">UI/UX Design</h3>
            </div>
            <p className="text-gray-600 flex-grow">Intuitive user interfaces and engaging user experiences designed to maximize usability and conversions.</p>
          </div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            ...
            <p className="text-gray-600 flex-grow">Websites that adapt seamlessly to all screen sizes and devices, providing an optimal viewing experience.</p>
          </div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            ...
            <p className="text-gray-600 flex-grow">Beautiful and functional online store designs that enhance product appeal and streamline the buying process.</p>
          </div>
          ...
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            ...
            <p className="text-gray-600 flex-grow">High-converting landing pages designed to capture leads and drive specific marketing campaign goals.</p>
          </div>
          
          <div className="bg-white p-6 border border-gray-200 shadow-lg flex flex-col">
            <div className="flex items-center mb-4">
              <FaDraftingCompass className="text-black mr-3 text-xl" />
              <h3 className="font-semibold text-xl">Website Redesign</h3>
            </div>
            <p className="text-gray-600 flex-grow">Modernizing outdated websites with fresh designs, improved usability, and alignment with current web standards.</p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 md:px-8 py-8 mb-16 bg-gray-50 border border-gray-200 shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="p-6 border-l-2 border-cyan-500">
            ...
            <p className="text-gray-600">Understanding your brand, audience, and goals to lay a strategic foundation for the design.</p>
          </div>
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">2. Wireframing & Prototyping</h3>
            <p className="text-gray-600">Creating blueprints and interactive mockups to define structure and user flow before visual design.</p>
          </div>
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">3. Visual Design</h3>
            <p className="text-gray-600">Crafting a stunning visual interface that aligns with your brand and captivates your users.</p>
          </div>
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">4. User Testing</h3>
            <p className="text-gray-600">Gathering feedback on designs from real users to identify areas for improvement and ensure usability.</p>
          </div>
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">5. Handoff & Collaboration</h3>
            <p className="text-gray-600">Providing developers with detailed design specifications and assets for seamless implementation.</p>
          </div>
          <div className="p-6 border-l-2 border-cyan-500">
            <h3 className="font-bold text-xl mb-2">6. Iteration & Refinement</h3>
            <p className="text-gray-600">Continuously refining designs based on feedback and performance data to achieve optimal results.</p>
          </div>
        </div>
      </section>
